            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-purple waves-effect waves-light month">Search</button>
                        </form>
                    </div><!-- panel-body -->
                </div> <!-- panel -->
            </div> <!-- col-->

         <div class="due_report"></div>
   ...
   <script>
     $(document).ready(function(){
        ...
        $(document).on("click", ".due_collection", function(e){
   		...
   		var id = $(this).data("id");
   		$.ajax({
             url: "{{  url('/monthly_due-collection/') }}/"+id,
     ...
     $(document).on("click", ".due_collect", function(e){
   	   e.preventDefault();
   	    ...
   	    var select_year = $(".select_year").val();
        $.ajax({
             url: "{{  url('/monthly_collect-due/') }}/"+id,

             type:"GET",
             data:{order_total:order_total, order_pay:order_pay, order_due:order_due,select_year:select_year, select_month:select_month},
             dataType:"html",
             success:function(data) {
             	 $(".due_report").html(data);
                 console.log(data);
